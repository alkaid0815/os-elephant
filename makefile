...
target/kernel.bin: target/main.o target/print.o target/init.o target/interrupt.o target/kernel.o
	ld -m elf_i386 -Ttext 0xc0001500 -e main -o target/kernel.bin target/main.o target/print.o target/init.o target/interrupt.o target/kernel.o
